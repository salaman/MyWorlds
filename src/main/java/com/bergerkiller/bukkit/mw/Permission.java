...
public class Permission extends PermissionEnum {
	...
	public static final Permission COMMAND_RESPAWN = new Permission("world.respawn", PermissionDefault.OP, "Sets if the player can teleport to world respawn point");
